...
| Test driving Chapter 1 (including prologue) and reach ending 1 | Integration Testing | 1. Run the program 2. Enter "N" to read prologue 3. Let the tester play the game (input 1,2,3).                                                              | Stream lined game and prologue with no bugs and typos.                                                                                                    |
...
Praise: The story line is really creative and exciting. I am close to escape. The endings are really clever. Well done.
